...
public class Ball {
    ...
    public void checkColisionWithBall(Ball ball2) {
        if(((x+r<=ball2.x+ball2.r || x-r<=ball2.x+ball2.r) && (x+r>=ball2.x-ball2.r || x-r>=ball2.x-ball2.r)  )
                && ((y+r<=ball2.y+ball2.r || y-r<=ball2.y+ball2.r) && (y+r>=ball2.y-ball2.r  || y-r>=ball2.y-ball2.r)))
        {
            vy=-vy;
            vx=-vx;
            ball2.vy=-ball2.vy;
